...
function CartProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const syncCart = async ()=>{
            if (user) {
                // SCENARIO A: User Logged In -> Use Firestore
                // 1. Check if we have local items to migrate (Merge Logic)
                const localCart = localStorage.getItem("hungerStationCart");
                if (localCart) {
                    const parsedLocal = JSON.parse(localCart);
                    if (parsedLocal.length > 0) {
                        console.log("🚀 Migrating local cart to Firestore...");
                        ...
                        parsedLocal.forEach((item)=>{
                            const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid, "cart", item.id);
                            batch.set(ref, item);
                        });
                        await batch.commit();
                        localStorage.removeItem("hungerStationCart"); // Clear local after upload
                    }
                }
                // 2. Real-time Listener (Firestore)
                const cartRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid, "cart");
                unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onSnapshot"])(cartRef, (snapshot)=>{
                    const items = snapshot.docs.map((doc)=>doc.data());
                    setCart(items);
                    setLoading(false);
                });
            } else {
                // SCENARIO B: Guest User -> Use LocalStorage
                const savedCart = localStorage.getItem("hungerStationCart");
                if (savedCart) {
    ...
    const addToCart = async (item)=>{
        ...
        if (user) {
            // Save to Firestore
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid, "cart", item.id), newItem);
            } catch (e) {
                console.error("Firestore Add Error", e);
            }
        } else {
            // Save to LocalStorage
            const newCart = existing ? cart.map((i)=>i.id === item.id ? newItem : i) : [
                ...cart,
                newItem
            ];
            setCart(newCart);
            localStorage.setItem("hungerStationCart", JSON.stringify(newCart));
        }
    };
    const decreaseQuantity = async (id)=>{
        ...
        if (user) {
            ...
            if (existing.quantity > 1) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], "users", user.uid, "cart", id), {
                    ...existing,
                    quantity: existing.quantity - 1
                });
            } else {
    ...
    const clearCart = async ()=>{
        if (user) {
            ...
            setCart([]);
            localStorage.removeItem("hungerStationCart");
        }
    };
    // --- CALCULATIONS ---
